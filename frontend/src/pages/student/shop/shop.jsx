...
const ShopEST = ({ setNavActive }) => {

    useEffect(() => setNavActive(NavParams.boutique), [])
                    ...
                    {data
                        ...
                        .map(
                            (product, index) => {
                                ...
                                return <ProductCard product={product} key={index} showDetail={() => {navigate(`/student/shop/acticle/${product._id}`)}} />
                            }
                        )}
                </div>
            </div>
