...
const BudgetMNG = ({ setNavActive }) => {
    ...
    const histData = {
        ...
        datasets: [
            { label: "Source de revenue", data: [10, 20, 30, 80, 28, 15, 36, 63, 81, 30], backgroundColor: "#094896" },
            { label: "Cout", data: [32, 2, 31, 40, 38, 45, 16, 23, 71, 10], backgroundColor: "#457FEB" },
        ]
    }
    ...
    const data1 = {
        ...
        datasets: [
            { label: "cost", data: [10, 20], backgroundColor: ["rgba(88, 152, 221, 0.4)", "#5899DD"] },
        ]
    }
    ...
    const data2 = {
        ...
        datasets: [
            { label: "cost", data: [15, 50, 35], backgroundColor: colors },
        ]
    }
        ...
        <div className="manager-budget">
            <div className="content">
                ...
                <div className="dashboard">
                    ...
                    <SimpleCard title={"Bénéfice net"} cost={"6000 $"} rate={"30%"} icon={<GoArrowUpRight/>}/>
                    <SimpleCard title={"Dépenses"} cost={"6000 $"} rate={"30%"} icon={<GoArrowDownRight/>}/>
                </div>
                <div className="bilan">
