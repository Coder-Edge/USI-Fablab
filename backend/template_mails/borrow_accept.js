...
Nous avons le plaisir de vous informer que votre demande d'emprunt (référence #${
    borrowDetails._id
  }) a été acceptée.
...
1. Le matériel doit être récupéré avant le ${formatDate(
    borrowDetails.startDate
  )}
2. Tout le matériel doit être retourné avant le ${formatDate(
...
<body>
    ...
    <p>Nous avons le plaisir de vous informer que votre demande d'emprunt <span class="ref-number">#${
      borrowDetails._id
    }</span> a été acceptée.</p>
    
    <div class="section">
        <div class="section-title">Détails de l'emprunt</div>
        <p><strong>Date de début :</strong> ${formatDate(
          borrowDetails.startDate
        )}</p>
    ...
    <div class="section conditions">
        ...
        <ol>
            <li>Le matériel doit être récupéré avant le ${formatDate(
              borrowDetails.startDate
            )}</li>
            <li>Tout le matériel doit être retourné avant le ${formatDate(
              borrowDetails.endDate
            )}</li>
